 ...
 */
/* Based on ListFragment by The Android Open Source Project (https://github.com/android/platform_frameworks_support/blob/f81fd8c39e5ca44a4adb2fb45f9b382305842d87/v4/java/android/support/v4/app/ListFragment.java) which included the following notice:
/*
...
public class ExpandableListFragment extends Fragment {
	...
	final private AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
			ExpandableListFragment.this.onListItemClick((ExpandableListView) parent, v, position, id);
		}
	};
	...
	final private ExpandableListView.OnChildClickListener mOnChildClickListener = new ExpandableListView.OnChildClickListener() {
		...
		public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
			return ExpandableListFragment.this.onChildClick(parent, v, groupPosition, childPosition, id);
		}
	};
	...
	final private ExpandableListView.OnGroupClickListener mOnGroupClickListener = new ExpandableListView.OnGroupClickListener() {
		...
		public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
			return ExpandableListFragment.this.onGroupClick(parent, v, groupPosition, id);
		}
	};
	...
	protected boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
		return false;
	}
	...
	private void ensureList() {
		...
		if (root instanceof ExpandableListView) {
			...
			if (!(rawListView instanceof ExpandableListView)) {
				if (rawListView == null) { throw new RuntimeException(
